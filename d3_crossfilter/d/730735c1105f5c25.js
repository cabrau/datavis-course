  ...
  main.variable(observer("buildcomposite")).define("buildcomposite", ["md","container","dc","d3","dateDim","googleByDayGroup","fbByDayGroup"], function(md,container,dc,d3,dateDim,googleByDayGroup,fbByDayGroup)
{
  ...
  main.variable(observer("pFbByDayGroup")).define("pFbByDayGroup", ["dateDim"], function(dateDim){return(
dateDim.group().reduceSum(d => d.pFacebook)
)});
  main.variable(observer("pGoogleByDayGroup")).define("pGoogleByDayGroup", ["dateDim"], function(dateDim){return(
dateDim.group().reduceSum(d => d.pGoogle)
)});
  main.variable(observer("acoes")).define("acoes", ["md","container","dc","d3","dateDim","pGoogleByDayGroup","pFbByDayGroup"], function(md,container,dc,d3,dateDim,pGoogleByDayGroup,pFbByDayGroup)
{
  let view = md`${container('chart3', 'Valores das ações do Google e do Facebook em porcentagem')}`
  ...
  compositeChart.width(800)
              ...
              .compose([
                  dc.lineChart(compositeChart)
                    .group(pGoogleByDayGroup, 'Google')
                    .ordinalColors(['steelblue']),
                  dc.lineChart(compositeChart)
                    .group(pFbByDayGroup, 'Facebook')
                    .ordinalColors(['darkorange'])])
  dc.renderAll()
  return view      
...
movies.dimension(d => d.Worldwide_Gross_M)
  ...
  main.variable(observer("grossByYearGroup")).define("grossByYearGroup", ["yearDim"], function(yearDim){return(
yearDim.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("grossByGenreGroup")).define("grossByGenreGroup", ["genreDim"], function(genreDim){return(
genreDim.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("by_year")).define("by_year", ["md","container","dc","yearDim","d3","grossByYearGroup"], function(md,container,dc,yearDim,d3,grossByYearGroup)
{
  ...
  main.variable(observer("by_genre")).define("by_genre", ["md","container","dc","yearDim","d3","grossByGenreGroup"], function(md,container,dc,yearDim,d3,grossByGenreGroup)
{
