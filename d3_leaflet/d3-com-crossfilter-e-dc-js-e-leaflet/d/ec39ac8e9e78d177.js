...
integrity="sha512xwE/Az9zrjBIphAcBb3F6JVqxf46+CDLwfLMHloNu6KEQCAWi6HcDUbeOfBIptF7tcCzusKFjFw2yuvEpDL9wQ=="crossorigin=""/>`
)});
...
let circle = L.circle([d.latitude, d.longitude], d.magnitude*1000, {
color: '#fd8d3c',
weight: 2,
fillColor: '#fecc5c',
fillOpacity: 0.5
})
circle.bindPopup("Magnitude: " + d.magnitude + "<br>" + "Profundidade: " + d.profundidade + "<br>" + d.dtg)
